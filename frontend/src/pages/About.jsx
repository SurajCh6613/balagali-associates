        ...
        >
          ...
          >
            ...
            <h2 className="font-serif text-2xl md:text-3xl lg:text-4xl font-bold text-foreground mb-6">
              Dedicated to <span className="text-gold">Your Rights</span>
            </h2>
            <div className="space-y-4 text-muted-foreground leading-relaxed mb-8">
              <p>
                I am Advocate Bhailappa C. Balagali, a senior practicing
                advocate with over two decades of experience in the Indian
                judicial system. My practice spans across civil, criminal,
            ...
            <div className="grid grid-cols-2 gap-4">
              {achievements.map((item, index) => (
                <motion.div
                  ...
                  className="flex items-start gap-3 p-4 rounded-xl bg-secondary/50 border border-border hover:border-gold/30 transition-colors"
                >
